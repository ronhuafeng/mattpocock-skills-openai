...
Upstream represents user-invoked skills in both Claude and OpenAI metadata. This
OpenAI-canonical mirror deliberately removes Claude-only invocation fields from
the deployment-selected aliases; their invocation policy lives in
`agents/openai.yaml`. Do not restore the removed fields in this mirror. See
